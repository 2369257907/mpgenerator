 ...
 * @since 2022-05-29
 */
public class 高军（664） implements Serializable {
    ...
    @TableField("YUANBU")
    private String yuanbu;

    @TableField("JIAOYANSHI")
    ...
    public String getYuanbu() {
        return yuanbu;
    }

    public void setYuanbu(String yuanbu) {
        this.yuanbu = yuanbu;
    }
    ...
    public Double getKk12() {
        return kk12;
    }

    public void setKk12(Double kk12) {
        this.kk12 = kk12;
    }
